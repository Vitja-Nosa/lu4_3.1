...
export const stepsMeta: StepMeta[] = [
  ...
  { icon: "ph-fill ph-wallet", iconBg: "rgba(224,123,123,0.16)", iconColor: "#B23A3A", number: 4 },
];
...
export const featuresMeta: FeatureMeta[] = [
  ...
  { icon: "ph-fill ph-pizza", iconBg: "rgba(224,123,123,0.16)", iconColor: "#B23A3A" },
  { icon: "ph-fill ph-globe-hemisphere-west", iconBg: "rgba(217,107,71,0.12)", iconColor: "#D96B47" },
];
